...
('api.com.hotel.search.keywordAutoComplete','7.1 酒店搜索关键字自动补全','1.0.0'),
...
('api.com.hotel.search.destinationAutoComplete','7.1 酒店搜索目的地自动补全','1.0.0'),
...
('api.com.home.homeSearch','首页搜索改版 查询爆款频道页数据','1.0.0'),
...
('api.com.route.search.chanelPageAroudRoute','客户端7.5版本 周边游频道页里面酒+景 跟团游 亲子游接口 标签调用的接口','1.0.0'),
...
('api.com.hotel.search.getHomeHotelConditions','7.1 酒店搜索首页获取价格/星级','1.0.0'),
('api.com.groupbuy.getTicketIndexList','首页门票(7.1版本)','2.0.0'),
('api.com.groupbuy.getSellPackageInfo','秒杀、团购详情页 套餐接口(7.4版本)','1.0.0'),
...
('api.com.hotel.search.getHotelCities4H5','7.3.2 度假酒店搜索酒店城市列表','1.0.0'),
('api.com.route.traffic.changeTraffic','线路更换交通 since 7.4','1.0.0'),
...
('api.com.route.search.searchAllCategory','7.4 线路搜索列表-出境游-搜索频道','1.0.0'),
...
('api.com.hotel.search.getHotelCities','7.1 酒店搜索酒店城市列表','1.0.0'),
...
('api.com.tdk.queryTdkRule','查询Title Description Title规则','1.0.0'),
...
('api.com.search.searchRouteHotel','7.4.1 首页搜索酒店tab页用','1.0.0'),
...
('api.com.trip.dest.getSeoVO','根据目的地id 获取 是否国外 父级目的地名称 当前目的地名称等信息','1.0.0'),
...
('api.com.cmt.getRecommendedComments','7.5 获取点评成功页的推荐点评信息','1.0.0'),
...
('api.com.other.getIosHotfix','IOS热修复获取文件信息（since v7.5）','1.0.0'),
('api.com.route.search.searchChanelPageAroudHotel','客户端7.5版本 周边游频道页里面 酒店搜索 标签调用的接口','1.0.0'),
...
('api.com.route.out.getLatestContacts','填写订单页加载最近联系人&amp;是否支持意向单 since7.5','1.0.0'),
...
('api.com.route.inner.product.getInnerLineDetail','国内行程结构化接口 信息 since7.5','1.0.0'),
...
('api.com.cmt.getPicMarks','7.5 拉取点评标签','1.0.0'),
...
('api.com.common.getVacations','获取节假日（since v7.5）','1.0.0'),
('api.com.train.order.cancelorder','取消订单','1.0.0'),
('api.com.other.subSuggest','意见反馈提交(@version 7.4.1接口迁移 )','1.0.0'),
('api.com.ship.search.autoCompleteShip','邮轮搜索自动补全','1.0.0'),
('api.com.route.quickorder.createOrderQuickOrder','快捷匿名下单','1.0.0'),
('api.com.wifi.order.checkTimePrice','wifi/电话卡 计算价格之前校验时间价格表接口','1.0.0'),
