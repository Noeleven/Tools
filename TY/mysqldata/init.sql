...
('api.com.duiba.deduct.point','兑吧','1.0.0'),
...
('api.com.duiba.handle.duibanotice','兑吧通知','1.0.0'),
...
('api.com.groupbuy.getWeekHotCollections','周爆款产品列表','1.0.0'),
...
('api.com.user.getCommentLatitudeInfos','获取普通点评维度信息','1.0.0'),
...
('api.com.user.isStrategyCollected','用户战略收集','1.0.0'),
...
('api.com.ticket.order.getInputOptions','获取门票下单页必填项信息','1.0.0'),
('api.com.ticket.order.getRelatedTicket','获取门票下单页添加其他票列表','1.0.0'),
('api.com.cmt.getRelatedCount','相关点评条数','1.0.0'),
('api.com.groupbuy.getAllPackageSnapshots','获取多出发地线路的特卖产品中某个出发地下的所有套餐的概要信息','1.0.0'),
('api.com.user.getBonusInfo','获取奖金','1.0.0'),
('api.com.route.lvf.getRouteProductGroupDate','线路交通自动打包产品_时间价格表_since7.7','1.0.0'),
('api.com.route.lvf.inputRouteOrder','线路交通自动打包产品_加载默认商品_since7.7','1.0.0'),
('api.com.route.lvf.countRoutePrice','线路交通自动打包产品_计算价格_since7.7','1.0.0'),
('api.com.route.lvf.createOrder','线路交通自动打包产品_创建订单_since7.7','1.0.0'),
('api.com.route.lvf.changeTraffic','线路交通自动打包产品_更换交通_since7.7','1.0.0'),
('api.com.route.lvf.getContractUrls','线路交通自动打包产品_获取合同_since7.7','1.0.0'),
('api.com.route.lvf.showContract','线路交通自动打包产品_展示合同_since7.7','1.0.0'),
('api.com.route.lvfhotel.loadRecommendGoods','线路交通机酒动态打包_查询默认推荐商品_since7.7.2','1.0.0'),
('api.com.route.lvfhotel.changeFlight','线路交通机酒动态打包_更换航班_since7.7.2','1.0.0'),
('api.com.route.lvf.lvfhotel.changeHotel','线路交通机酒动态打包_更换酒店_since7.7.2','1.0.0'),
('api.com.route.lvf.lvfhotel.getProductDetail','线路交通机酒动态打包_酒店详情_since7.7.2','1.0.0'),
('api.com.route.lvf.lvfhotel.countRoutePrice','线路交通机酒动态打包_计算价格_since7.7.2','1.0.0'),
('api.com.route.lvf.lvfhotel.getContract','线路交通机酒动态打包_合约_since7.7.2','1.0.0'),
('api.com.route.lvf.lvfhotel.bookinglvfHotel','线路交通机酒动态打包_创建订单_since7.7.2','1.0.0'),
('api.com.user.couponBinding','优惠券绑定','1.0.0'),
('api.com.order.commitPreSellOrdRefundOnline','预授券订单退款信息提交(7.6.3)','1.0.0'),
('api.com.ticket.product.getInsurance','获门票保险信息(7.6.2)','1.0.0'),
('api.com.route.lvf.getContractUrls','线路交通自动打包产品-获取合同_since7.7','1.0.0'),
('api.com.user.geetest.enhencedValidate','极验再验校验接口','1.0.0'),
('api.com.login.union.tryLogin','第三方登录，获得授权码后，进行登录','1.0.0'),
('api.com.groupbuy.route.order.countRoutePrice','线路订单计算总价','1.0.0'),
('api.com.groupbuy.route.product.getRouteProductGroupDate','线路时间价格表','1.0.0'),
('api.com.groupbuy.route.order.inputRouteOrder','线路填写订单','1.0.0'),
('api.com.groupbuy.route.order.createOrder','提交线路订单','1.0.0'),
('api.com.groupbuy.route.order.countRoutePrice','线路订单计算总价','1.0.0'),
('api.com.order.getRefundDetailByTicketCode','预授券已退款券对应退款详情','1.0.0'),
('api.com.order.canclePreSellOrder','预授券订单取消','1.0.0'),
('api.com.duiba.nologin.url','兑吧免登陆获取URL','1.0.0'),
('api.com.route.order.getOrderStatus','获取订单审核状态','1.0.0'),
('api.com.groupbuy.ticket.goods.getGoodsTimePrice','门票时间价格表','1.0.0'),
('api.com.order.getRefundDetailByTicketCode','预授券已退款券对应退款详情','1.0.0'),
...
-- INSERT INTO ty_rate (`des`,`ms_level`,`one_level`,`two_level`,`three_level`,`four_level`,`five_level`)
-- VALUES
-- ('5月前2周','0%','59%','23%','7%','4%','7%'),('5月后2周','31%','49%','17%','5%','3%','4%'),
-- ('6月前2周','26%','50%','13%','7%','2%','2%'),('6月后2周','64%','23%','8%','3%','1%','2%'),
-- ('7月前2周','68%','20%','6%','3%','2%','2%'),('7月后2周','63%','26%','6%','3%','1%','2%'),
-- ('8月前2周','72%','19%','5%','3%','1%','2%');
